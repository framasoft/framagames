...
mit.main = function() {
  ...
  */
  ...
  try {
    ...
    if (mit.highScore)
      ui.high_score.text("Record : "+ mit.highScore);
  ...
  */
  mit.gameOver = function() {
    ...
    // Show last_score
    ui.last_score.text("Dernier score : " + parseInt(mit.score));


    ui.start_game.html('rejouer');
    ui.tweet.html('tweeter score');
    ui.fb.html('poster sur fb');
    ...
    // Share
    var tweet = document.getElementById("tweet");
    tweet.href='http://twitter.com/share?url=http://khele.in/pappu-pakia/&text=Je viens d\'avoir ' +Math.floor(mit.score)+ ' points à Pappu Pakia !&count=horiztonal&via=_rishabhp&related=solitarydesigns';
  
    var facebook = document.getElementById("fb");
    facebook.href='http://facebook.com/sharer.php?s=100&p[url]=http://khele.in/pappu-pakia/&p[title]=Je viens d\'avoir' +Math.floor(mit.score)+ ' points à Pappu Pakia !';
